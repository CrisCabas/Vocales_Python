...
class detectormanos():
    ...
    def vocal(self):
        vocal = "--"
        # Vocal a
        if (self.dedos == [1, 0, 0, 0, 0]) and (self.dedos == [1, 0, 0, 0, 0]):
            if (self.lista[0][2]-500 < self.lista[4][2]) and (self.lista[4][2] < self.lista[0][2]):
                vocal = "A" 
        # Vocal e
        if self.dedos == [0, 0, 0, 0, 0]:
            vocal = "E"
        # Vocal i
        if self.dedos == [0, 0, 0, 0, 1]:
            vocal = "I"
        # Vocal 0
        if self.lista != []:
            if(self.lista[4][2]-45 < self.lista[8][2])and(self.lista[4][1]-30 < self.lista[8][1])and  (self.lista[4][2]-45 < self.lista[12][2])and(self.lista[4][1]-44 < self.lista[12][1])and  (self.lista[4][2]-45 < self.lista[20][2])and(self.lista[4][1]-50 < self.lista[20][1]):
                vocal = "O"
                print(self.lista[8])
                print(self.lista[8][1])
        # Vocal u
        if self.dedos == [0, 1, 0, 0, 1]:
            vocal = "U"
        return vocal
